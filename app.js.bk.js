...
var tanks = {};
tanks[tankIds[0]] = { name:"JR1", tubeLength: 1847, height:1600, capacity:6500, type: "rond65"};
tanks[tankIds[1]] = { name:"JR2", tubeLength: 1375, height:1070, capacity: 900, type: "u42.5"};
    ...
    Promise.all(tankIds.map(function(id) {
      ...
      var queryDevices = function() {
        tanks.forEach(function(tank) {
          update(tank);
          // console.log("updating " + tank.name);
        });
...
function raw2gallons(raw, tankId) {
  ...
  console.log("raw2gallons: " + raw + "= " + (fillFactor * 100).toFixed(0) + "%");
